...
**DrCarfrei - Cybersecurity Researcher & Ethical Hacker | Security Analyst**

Repository documenting my journey in offensive and defensive cybersecurity. This space showcases practical labs, pentesting projects, security research, vulnerability analysis, and development of security tools focused on real-world scenarios.
...
- 🤝 **100% Ethical** - All activities with appropriate authorization and educational intent

---
## 📈 Challenge Progress

**Tracking my path towards mastery across multiple platforms:**

| Platform | Progress | Count | Link |
|----------|----------|-------|------|
| **HackTheBox** | 🟦🟦⬜⬜⬜ | 7/1452 (0.5%) | [View →](htb/) |
| **TryHackMe** | 🟦⬜⬜⬜⬜ | 1/25 (4%) | [View →](THM/readme.md) |
| **OverTheWire** | 🟦⬜⬜⬜⬜ | 6/59 (10%) | [View →](overthewire/) |
| **PicoCTF** | ⬜⬜⬜⬜⬜ | 0/100 (0%) | [View →](picoctf/) |
| **VulnHub** | ⬜⬜⬜⬜⬜ | 0/500 (0%) | [View →](vulnhub/) |
| **Tools** | 🟦⬜⬜⬜⬜ | 1/5 (ALPHA) | [View →](tools/) |

**Overall Total:** 15/2111+ (0.71%)

*Actively developing portfolio - publicly tracking progress for accountability*
...
| 🎮 **OverTheWire** | OverTheWire | 6/59 | [View →](overthewire/) |
...
- **Kernel:** Linux
- **Pre-installed Tools:** Complete penetration testing suite
...
- 🎓 **OWASP** - Documentation and security guides
...
> **IMPORTANT:** All projects, tools, and techniques presented in this repository are **solely for educational and security research purposes**.
>
> - ✅ **Ethical Hacking**: All tests performed in controlled environments or with explicit authorization
> - ✅ **Responsible Disclosure**: Following best practices for reporting vulnerabilities
> - ✅ **Legal Compliance**: Respecting all applicable laws and regulations
> - ❌ **No Misuse**: Not responsible for unauthorized use of shared information
>
...
- [ ] Complete more than 50 machines on HackTheBox/TryHackMe
- [ ] Master OWASP Top 10 with practical labs
- [ ] Develop more than 10 automation scripts in Python
- [ ] Obtain first security certification
- [ ] Participate in more than 5 CTFs
...
- **Username:** DrCarfrei (White Hat Security Researcher)
...
*Actively tracking HTB/THM progress and security research journey*
---

**Last Update:** January 12, 2026 | **Status:** 🌱 Active Learning | **Location:** Quito, Ecuador 🇪🇨 | **License:** MIT